...
This document describes the schema used by [claude_sexy_logger](https://github.com/russellballestrini/claude_sexy_logger) (unfirehose) to ingest, normalize, and query sessions from multiple harnesses. It serves as both documentation of what exists and a proposal for what the industry should converge on.
