...
const HARNESSES = [
  ...
  },
  {
    id: 'uncloseai',
    name: 'uncloseai',
    desc: 'Free LLM and TTS — OpenAI-compatible API on unturf infrastructure',
    repo: 'https://git.unturf.com/engineering/unturf/uncloseai.com',
    install: 'git clone && mix deps.get && mix phx.server',
    run: 'mix phx.server',
    tags: ['ml', 'api', 'elixir', 'self-hosted'],
  },
  {
    id: 'llama-cpp',
    name: 'llama.cpp',
