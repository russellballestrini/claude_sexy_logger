...
export default function ThinkingPage() {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-3rem)]">
      <PageContext
        pageType="thinking"
        summary={`Thinking stream. ${total} blocks. Date: ${datePreset}. Search: "${searchDebounced || 'none'}".`}
        metrics={{ thinking_blocks: total, date: datePreset, search_query: searchDebounced || 'none' }}
      />
